"""Compatibility auto-configuration for neurOS.

Concrete drivers and models are imported lazily so importing ``neuros-core``
does not require the driver/model distributions. New applications should prefer
versioned configuration plus plugin discovery.
"""
