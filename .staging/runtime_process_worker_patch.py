...
text = replace_once(
    ...
    "            },\n"
    "        }\n",
    "semantic receipts snapshot",
)
path.write_text(text, encoding="utf-8")


test_path = Path("tests/test_runtime_execution_authority.py")
